...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-primary">
        <a class="navbar-brand" href="<?php echo base_url(); ?>admin/listar">UES Temoaya</a>
        ...
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                ...
                <div class="sb-sidenav-footer bg-primary">
                    <div class="small"></div>
                    <a href="https://www.facebook.com/umbtemoaya?mibextid=ZbWKwL" class="text-white"><i class="fab fa-facebook-square"></i>@UMB Temoaya</a>
                </div>
