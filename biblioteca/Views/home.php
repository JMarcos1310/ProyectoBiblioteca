...
<head>
    ...
    <title>Biblioteca UEST</title>
    <link rel="stylesheet" href="<?php echo base_url(); ?>Assets/css/styles.css" id="theme-stylesheet">
</head>

<body class="bg-primaryy" img = "background-image :url('fondo.jpeg') no-repeat; background-size:coner;">
   <!-- <img class="fondo" type="image/jpg" src="Assets/img/fondo.jpeg"> -->
                        ...
                        <div class="col-lg-5">
                            <div class="card border-0 rounded-lg mt-5 sb-sidenav-dark">
                                <div class="card-header text-center ">
                                    <h3 class="font-weight my-4">Biblioteca UEST</h3>
                                ...
                                <div class="card-body">
                                    <form action="<?php echo base_url(); ?>Usuarios/login" method="post" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <strong class="password-white">Contraseña</strong>
